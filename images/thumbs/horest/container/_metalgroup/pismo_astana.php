...
<body>
	<div id="header"><div class="container">
			...
			<ul>
				...
				<li><a href="services.html"><span>Доставка</span></a></li><li><a href="otzovik.php"><span>Отзывы</span></a></li>
	...
	<div id="body">
		...
		<div class="section">
				...
				<h3>Каталог</h3>
					...
					<li><p><a href="obor.html"><img src="images/bullets.gif"> Торговое оборудование </a></p><hr></li><li><p><a href="holod.html"><img src="images/bullets.gif"> Холодильное оборудование</a></p><hr></li><li><p><a href="kassovyie_boksyi.html"><img src="images/bullets.gif"> Кассовые боксы </a></p><hr></li>	<li><p><a href="pos_obor.html"><img src="images/bullets.gif"> POS оборудование </a></p><hr></li>	
					<li>
...
<li>
			...
			<div class="featured">
			<div class="napravo">
			<div class="main" style="padding: 0 45px 10px; ">
				
				<br><br>
				  <p style="font-size: 14px;"><b>Если Вы хотите оставить заявку, заполните эту форму.</b></p>
				
 <br><p style="font-size: 14px;">Пожалуйста, заполните все обязательные поля. Свяжемся с Вами в ближайшее время.</p>
 <br><p style="font-size: 14px;">Или пишите на почту:  <b>astana@idiamarket.kz</b></p>
<form action="https://formspree.io/astana@idiamarket.kz"
      method="POST">
	  <br>
	  <p style="font-size:14px;">Ваше имя (наименование организации)<span class="asterisk">*</span></p>
   <input type="text" name="name" class="textbox" required />
   <p style="font-size:14px; margin-top:10px;">Ваш e-mail<span class="asterisk">*</span></p>
  <input type="text" name="email" class="textbox"/>
	  <p style="font-size:14px; margin-top:10px;">Номер телефона<span class="asterisk">*</span></p>
    <input id="phone" type="text" name="phone" class="textbox" required />
	<p style="font-size:14px; margin-top:10px; float:none">Ваше сообщение<span class="asterisk">*</span></p>
  <textarea type="text" name="message" class="textbox1" style="float:none;"></textarea>
	<input type="hidden" name="_next" value="pismo_astana.php" />
